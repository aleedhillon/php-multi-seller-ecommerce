			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
						<li id="home"><a class="nav-link" href="/client/index.php">Home</a></li>
						<li id="shop"><a class="nav-link" href="/client/shop.php">Shop</a></li>
						<li id="about"><a class="nav-link" href="/client/about.php">About us</a></li>
						<li id="contact"><a class="nav-link" href="/client/contact.php">Contact us</a></li>
					</ul>
					<ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5 d-flex align-items-center">
						...
						<li class="me-3">
							...
							<a class="nav-link" href="/vendor/convert.php">
						...
						<ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
									...
									<li><a class="dropdown-item" href="/vendor/annoucements.php">Announcements</a></li>
									<li><a class="dropdown-item" href="/vendor/add.php">Add Product</a></li>
						...
						<ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
							<li class="nav-item dropdown">
								<a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
									<i class="fas fa-bars fs-4 text-white"></i> </a>
								<ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
									<li><a class="dropdown-item" href="/admin/admin.php">Dashboard</a></li>
